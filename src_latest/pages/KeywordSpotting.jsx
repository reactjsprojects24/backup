...
import { getKeywordsByGroupThunk, spotKeywordsThunk } from '../redux/thunks/keywordSpottingThunks';
...
function KeywordSpotting({ groupName }) {
  ...
  console.log("keywordGroups --------in ks", keywordGroups?.group_name, " keywordList ", keywordGroups?.keywords);
  ...
  useEffect(() => {
    ...
    if (keywordGroups) {
      ...
      if (keywordGroups && keywordGroups.group_name) {
        extractedGroups.push({ id: keywordGroups.id, name: keywordGroups.group_name });
      }
  ...
  //   dispatch(spotKeywordsThunk({ keyword, caseSensitive, wholeWord, synonyms, model }));
  // };
      ...
      <Grid2 container spacing={1}>
        <Grid2 item spacing={2} size={{ xs: 12, sm: 7, md: 7 }}
          ...
          <Box sx={{
            ...
            {/* <Typography variant="h5" >Spotting keywords in the audio files  11111111111</Typography> */}
            <Typography variant="h5">Select audio files for keywords spotting </Typography>
          ...
          <Grid2 container spacing={2}>
            ...
            {/* Selecting groups and display keywords */}
                  ...
                  <div className="keywords-section" style={{
                    ...
                    <div style={{
                      ...
                      <label
                        ...
                        <input type="checkbox" />
                        <span style={{ marginLeft: '5px' }}>{keywordsInGroup?.keywords}</span>
                      </label>
                    </div>
                  </div>
                </div>
        ...
        <Grid2 item size={{ xs: 12, sm: 5, md: 5 }}>
          <Box sx={{
            ...
            <Box sx={{
              ...
              <Typography variant='h5'>Spotted keywords in the given audio files</Typography>
            </Box>
