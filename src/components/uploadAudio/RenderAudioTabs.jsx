...
export default function RenderAudioTabs({ file, metadata }) { // Receive the file prop
    ...
    const uploadedFile = useSelector((state) => state.audio.audioFiles);
    ...
    const handleApplyNoiseRemoval = () => {
        ...
        console.log("Apply Now777777777777", payload);
        dispatch(noiseRemovalAudioThunk(payload));
                    ...
                    <Box sx={{ justifyContent: 'flex-end', display: 'flex', }}>
                        <FormControl sx={{ m: 1, minWidth: 170 }} size="small">
                            ...
                            >
                                ...
                                <MenuItem value="channel3">Channel3</MenuItem>
                            </Select>
                        </FormControl>
